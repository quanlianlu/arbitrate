...
#REMOTE_IP=10.1.235.183
REMOTE_IP=10.1.237.245

REMOTE_HOME=/opt/steward
echo "开始上传'$TAR_NAME'到远程'$REMOTE_IP'的最新应用目录"
scp $TAR_NAME root@$REMOTE_IP:$REMOTE_HOME/recent
echo "连接服务器10.129.194.173"
ssh -tt root@$REMOTE_IP << remotessh
cd $REMOTE_HOME
echo "备份应用"
